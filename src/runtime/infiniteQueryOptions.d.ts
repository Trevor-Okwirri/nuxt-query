import type { DataTag, DefaultError, InfiniteData, NonUndefinedGuard, QueryKey } from '@tanstack/query-core';
import type { UseInfiniteQueryOptions } from './composables/useInfiniteQuery.js';
